 ...
 */
class auth_plugin_emailhcaptcha extends auth_plugin_base {

    /**
     * Constructor.
     */
    public function __construct() {
        $this->authtype = 'emailhcaptcha';
        $this->config = get_config('auth_emailhcaptcha');
    }
    ...
    public function user_signup_with_confirmation($user, $notify=true, $confirmationurl = null) {
        ...
        if (! send_confirmation_email($user, $confirmationurl)) {
            print_error('auth_emailnoemail', 'auth_emailhcaptcha');
        }
