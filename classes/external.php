 ...
 * @copyright  based on work by 2016 Juan Leyva <juan@moodle.com> 
...
class auth_email_external extends external_api {
    ...
    protected static function check_signup_enabled() {
        ...
        if (empty($CFG->registerauth) or $CFG->registerauth != 'emailhcaptcha') {
    ...
    public static function get_signup_settings_returns() {
        ...
        return new external_single_structure(
            array(
                ...
                'hcaptchapublickey' => new external_value(PARAM_RAW, 'hcaptcha public key', VALUE_OPTIONAL),
                'hcaptchachallengehash' => new external_value(PARAM_RAW, 'hcaptcha challenge hash', VALUE_OPTIONAL),
                'hcaptchachallengeimage' => new external_value(PARAM_URL, 'hcaptcha challenge noscript image', VALUE_OPTIONAL),
                'hcaptchachallengejs' => new external_value(PARAM_URL, 'hcaptcha challenge js url', VALUE_OPTIONAL),
    ...
    public static function signup_user_parameters() {
        return new external_function_parameters(
            array(
                ...
                'hcaptchachallengehash' => new external_value(PARAM_RAW, 'hcaptcha challenge hash', VALUE_DEFAULT, ''),
                'hcaptcharesponse' => new external_value(PARAM_NOTAGS, 'hcaptcha response', VALUE_DEFAULT, ''),
     ...
     * @param  string $hcaptchachallengehash hcaptcha challenge hash
    ...
    public static function signup_user($username, $password, $firstname, $lastname, $email, $city = '', $country = '',
                                        $hcaptchachallengehash = '', $hcaptcharesponse = '', $customprofilefields = array(),
                                        $redirect = '') {
        global $CFG, $PAGE;
        ...
        $params = self::validate_parameters(
            ...
            array(
                ...
                'city' => $city,
                'country' => $country,
                'hcaptchachallengehash' => $hcaptchachallengehash,
